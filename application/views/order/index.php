                            ...
                            <?php foreach ($order as $order_item): ?>
                                    <tr>
                                        <?php echo form_open('order/index/delete') ?>
                                            <td style='display:none'><?php echo $order_item['rowid']; ?></td>
                                            <td><?php echo $order_item['order_id']; ?></td>
                                            <td><?php echo $order_item['product_name']; ?></td>
                                            <td><?php echo $order_item['sell_price']; ?></td>
                                            <td><?php echo $order_item['entry_time']; ?></td>
                                            <td><?php echo $order_item['update_time']; ?></td>
                                            <td>
                                                <a href="/index.php/order/edit/<?php echo $order_item['rowid']; ?>" class="btn btn-danger btn-xs" >View/Edit</a>
                                                
                                                <input type="hidden" name="rowid" value="<?php echo $order_item['rowid']; ?>">
                                                <button style="display:none"type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#delete_order_<?php echo $order_item['rowid'];?>">Delete</button>

                                                <!-- Modal -->
                                                <div class="modal fade" id="delete_order_<?php echo $order_item['rowid']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                  <div class="modal-dialog">
                                                    <div class="modal-content">
                                                      ...
                                                      <div class="modal-footer">
                                                        ...
                                                        <button type="button" class="btn btn-primary" onclick="delete_order('<?php echo $order_item['rowid']; ?>')">Yes, Delete</button>
                                                      </div>
                                                    </div>
                                                  </div>
                                                </div>
